...
# 上下文长度: 256 (按要求配置 256 上下文，KV Cache 轻量极速)
...
# 确保 ninja 与 Python 编译环境在系统 PATH 中，彻底解决 JIT ninja 报错
...
echo "[$(date)] Starting vLLM(105) server for DeepSeek-V4-Flash-0731-W8A8 (8卡 TP8, 256 Context)..."
