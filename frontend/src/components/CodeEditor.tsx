...
export const CodeEditor: React.FC<CodeEditorProps> = ({ filename, initialCode, onSave }) => {
  ...
  return (
    <div className="flex flex-col h-full min-h-[450px] bg-[#1e1e1e] rounded-lg overflow-hidden border border-slate-800 shadow-2xl">
      {/* 顶部工具栏 */}
      <div className="bg-slate-900 px-4 py-2.5 border-b border-slate-800 flex items-center justify-between shrink-0">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={handleCopy}
            className="px-2.5 py-1 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded text-xs flex items-center gap-1.5 transition cursor-pointer"
          >
          ...
          {isDirty && (
            <button
              onClick={handleReset}
              className="px-2.5 py-1 bg-slate-800 hover:bg-slate-700 text-slate-400 hover:text-slate-200 rounded text-xs flex items-center gap-1.5 transition cursor-pointer"
            >
          ...
          <button
            ...
            className="px-3.5 py-1 bg-indigo-600 hover:bg-indigo-500 disabled:bg-slate-800 disabled:text-slate-500 text-white rounded text-xs font-semibold flex items-center gap-1.5 transition shadow-sm cursor-pointer"
          >
      ...
      <div className="flex-1 w-full h-full min-h-[400px] overflow-hidden relative">
        <Editor
          height="100%"
          language="shell"
          theme="vs-dark"
          ...
          options={{
            fontSize: 13,
            fontFamily: "'Sarasa Term SC Nerd', 'Sarasa Term SC', 'Sarasa Mono SC', ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace",
